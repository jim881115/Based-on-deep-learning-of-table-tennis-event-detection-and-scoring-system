...
img, img1, img2, img3, img4 = None, None, None, None, None
...
print("finish")
#python3  predict_video.py  --save_weights_path=weights/model14p.h5 --input_video_path="/home/tt/TableTennis/TrackNet/test3.mp4" --output_video_path="" --n_classes=256
